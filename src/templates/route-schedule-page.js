          ...
          <AppBar position="static" color="default" elevation={0} style={{ display: 'flex', background: 'white' }}>
            <Toolbar elevation={0} style={{ flexDirection: 'column', alignItems: 'flex-start' }}>
              <span style={{ margin: 0, padding: '.5em 0em', fontSize: '1.5em', display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                <span style={{ marginLeft: '.25em' }}><RouteBadge id={r.routeShortName} showName/></span>: <span style={{ fontWeight: 700, paddingLeft: '.2em' }}>Schedule</span>
              </span>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center', marginBottom: '.5em' }}>
                <span style={{ fontSize: '.9em' }}>Buses make additional stops between major stops; see a list of all stops on the <Link to={`/route/${r.routeShortName}/stops`} style={{ color: 'black' }}>BUS STOPS</Link> tab.</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', marginBottom: '.5em' }}>
                ...
                <span style={{ background: chroma(r.routeColor).alpha(0.25).css(), fontSize: '.9em', marginLeft: '.25em', padding: '.15em' }}> current trips.</span>
              </div>
            </Toolbar>
          </AppBar>
